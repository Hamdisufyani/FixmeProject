...
class HandlingDataView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Center(child: Lottie.asset(AppImageAsset.server,width: 250, height: 250, repeat: false)) :
...
class HandlingDataRequest extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return
      ...
      statusRequest ==StatusRequest.serverFailure ?
      Center(child: Lottie.asset(AppImageAsset.server,width: 250, height: 250, repeat: false)) :widget ;
